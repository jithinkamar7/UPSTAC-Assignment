...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        return testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED);    //Returning the Requests List of status 'LAB_TEST_COMPLETED'.
    ...
    public List<TestRequest> getForDoctor() {
        ...
        User user_Doctor = userLoggedInService.getLoggedInUser();   //To get the current User
        return testRequestQueryService.findByDoctor(user_Doctor);   //To get the list
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            User user_Doctor = userLoggedInService.getLoggedInUser();   //To get the current User
            return testRequestUpdateService.assignForConsultation(id,user_Doctor);  //To assign the particular id to the current user
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            User user_Doctor = userLoggedInService.getLoggedInUser();   //To get the current User
            return testRequestUpdateService.updateConsultation(id,testResult,user_Doctor);  //To update the current test request id with the testResult details by the current user(object created)
